...
URL:            https://github.com/digitaltrails/ddcutil-dbus
Source0:        https://github.com/digitaltrails/ddcutil-dbus/archive/refs/tags/v1.0.0.tar.gz#/%{name}-%{version}.tar.gz
BuildRequires: make
BuildRequires: gcc-c++
